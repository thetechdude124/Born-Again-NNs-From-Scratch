...
$$ \frac{1}{b}\sum^{b}_{s=1}xyz\sum^n_{i=1} \frac{\partial \ell_{i,s}}{\partial z_{i,s}}=\frac{1}{b} \sum^{b}_{s=1} (q_{\ast,s}-p_{\ast,s})+\frac{1}{b} \sum^{b}_{s=1} \sum^{n-1}_{i=1}(q_{i,s}-p_{i,s}) $$
